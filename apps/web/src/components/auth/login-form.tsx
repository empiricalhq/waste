...
export function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  function onSubmit(data: SignInSchema) {
    startTransition(async () => {
      ...
      // La navegación exitosa la maneja el server action con redirect.
    });
  }
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground text-balance">Inicia sesión en Lima-Limpia</p>
            </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="mt-6 flex w-full flex-col gap-5">
                ...
                <div className="text-center text-sm">Solicita tu cuenta a tu supervisor directo.</div>
              </form>
            </Form>
          </div>
